...
cmake `
    ...
    "-DXEO3_CONTINUOUS_STATE_PUBLICATION:BOOL=OFF" `
...
cmake `
    ...
    --target `
        ...
        ac6_audio_poll_tests `
        ac6_vd_swap_trace_tests `
        ac6_fast_critical_section_tests `
        ac6_fast_irql_tests `
        ac6_fast_spin_lock_tests `
...
foreach ($requiredExport in @(
    ...
    'BridgeAc6AudioPollCallCount',
    'BridgeAc6AudioPollReturnCount',
    'BridgeAc6AudioPollSampleCount',
    'BridgeAc6AudioPollContinueCount',
    'BridgeAc6AudioPollTimeoutCount',
    'BridgeAc6AudioPollExitCount',
    'BridgeAc6AudioPollTimeBaseSampleCount',
    'BridgeAc6AudioPollClockFallbackCount',
    'BridgeAc6AudioPollDelayCount',
    'BridgeAc6AudioPollLastGuestIar',
    'BridgeAc6AudioPollLastThreadId',
    'BridgeAc6AudioPollLastObject',
    'BridgeAc6AudioPollLastFrame',
    'BridgeAc6AudioPollLastGuestMemory',
    'BridgeAc6AudioPollLastTimeBase',
    'BridgeAc6AudioPollLastGlobalTick',
    'BridgeAc6AudioPollLastGlobalClock',
    'BridgeAc6AudioPollLastObjectClock',
    'BridgeAc6AudioPollLastBaselineTick',
    'BridgeAc6AudioPollLastDelta',
    'BridgeAc6AudioPollLastConsumerPointer',
    'BridgeAc6AudioPollLastConsumerValue',
    'BridgeAc6AudioPollLastObservedConsumer',
    'BridgeAc6AudioPollLastRequiredDistance',
    'BridgeAc6AudioPollLastAvailableDistance',
    'BridgeAc6AudioPollLastReturn',
    ...
    'BridgeVgpuConstantUploadContextCount',
    'BridgeVgpuConstantUploadContextFailureCount',
    'BridgeVgpuConstantUploadLastContext',
    'BridgeVgpuConstantUploadLastCpuBase',
    'BridgeVgpuConstantUploadLastGpuBase',
    'BridgeVgpuConstantUploadLastStride',
    'BridgeVgpuConstantUploadLastSlotCount',
    'BridgeVgpuConstantUploadLastMappedSpan',
    'BridgeVgpuRestartTerrainPipelineCount',
    'BridgeVgpuRestartSkyPipelineCount',
    'BridgeVgpuRestartPipelineOverflowCount',
    'BridgeVgpuRestartTerrainDrawCount',
    'BridgeVgpuRestartSkyDrawCount',
    ...
    'BridgeVgpuRestartTerrainLastVertexCount',
    'BridgeVgpuRestartTerrainLastStartVertex',
    'BridgeVgpuRestartTerrainMaxStartVertex',
    'BridgeVgpuRestartSkyLastVertexCount',
    'BridgeVgpuRestartSkyLastStartVertex',
    'BridgeVgpuRestartSkyMaxStartVertex',
    'BridgeVgpuRestartLastClassification',
    'BridgeVgpuRestartLastPipelineState',
    'BridgeVgpuRestartLastInstanceCount',
    'BridgeVgpuRestartLastStartInstance',
    'BridgeVgpuRestartLastThreadId',
    'BridgeVgpuRestartLastDrawCall',
    'BridgeVgpuRestartConstantResolveCount',
    'BridgeVgpuRestartConstantResolveFailureCount',
    'BridgeVgpuRestartLastResolveFailure',
    'BridgeVgpuRestartLastRootDescriptorTable',
    'BridgeVgpuRestartLastDescriptorHeapGpuStart',
    'BridgeVgpuRestartLastDescriptorHeapCpuStart',
    'BridgeVgpuRestartLastDescriptorHeapByteSpan',
    'BridgeVgpuRestartLastDescriptorHeapIncrement',
    'BridgeVgpuRestartLastCpuDescriptor',
    'BridgeVgpuRestartLastDescriptorWord0',
    'BridgeVgpuRestartLastDescriptorWord1',
    'BridgeVgpuRestartLastDecodedGpuAddress',
    'BridgeVgpuRestartLastUploadContextKind',
    'BridgeVgpuRestartStartMatchesVertexOffsetCount',
    'BridgeVgpuRestartStartMismatchesVertexOffsetCount',
    'BridgeVgpuRestartLastConstantGpuAddress',
    'BridgeVgpuRestartLastConstantCpuAddress',
    'BridgeVgpuRestartLastVertexOffsetBits',
    'BridgeVgpuRestartLastUseIndexBuffer',
    'BridgeVgpuRestartLastIndexCount',
    'BridgeVgpuRestartLastVfetchEndianness',
    'BridgeVgpuRestartLastPackedIbDesc',
    'BridgeVgpuRestartLastResetIndex',
    'BridgeVgpuRestartLastIbBase',
    'BridgeVgpuRestartTerrainLastVertexOffsetBits',
    'BridgeVgpuRestartTerrainLastIndexCount',
    'BridgeVgpuRestartTerrainLastPackedIbDesc',
    'BridgeVgpuRestartSkyLastVertexOffsetBits',
    'BridgeVgpuRestartSkyLastIndexCount',
    'BridgeVgpuRestartSkyLastPackedIbDesc',
    ...
    'BridgeVgpuMsaaViewportFixEnabled',
    'BridgeVgpuMsaaViewportCandidateCount',
    'BridgeVgpuMsaaViewportFixCount',
    'BridgeVgpuMsaaViewportFixFailure',
    ...
    'BridgeVgpuMsaaViewportLastVertexCount',
